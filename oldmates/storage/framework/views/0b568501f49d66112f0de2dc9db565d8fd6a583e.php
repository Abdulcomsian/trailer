        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex align-items-center centerMobile">
                    ...
                    <a href="#"><img src="<?php echo e(asset('assets/img/setting.png')); ?>" alt="setting"></a>
                </form>
            </div>
        </div>
    </nav>
    ...
    <div class="hero_div">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <!-- <img src="<?php echo e(asset('assets/img/hero_Car.png')); ?>" class="w-100" alt="hero_Car"> -->
                      <!-- Swiper -->
                    ...
                    <div class="text">
                        ...
                        <form class="header_form mt-5">
                            <div class="input mb-5 position-relative">
                                ...
                                <!-- <span class="icon">
                                    <img src="<?php echo e(asset('assets/img/drop_arrow.png')); ?>" alt="drop_arrow">
                                </span> -->
                            </div>
                            <div class="input mb-5 position-relative">
                                ...
                                <span class="icon">
                                    ...
                                    <!-- <img src="<?php echo e(asset('assets/img/calendar-outline.png')); ?>" alt="calendar-outline"> -->
            ...
            <div class="row px-lg-4 mt-5">
                <div class="col-lg-4">
                    <div class="box">
                        ...
                        <img src="<?php echo e(asset('assets/img/boximg1.png')); ?>" alt="box">
                ...
                <div class="col-lg-4">
                    <div class="box box_2">
                        ...
                        <img src="<?php echo e(asset('assets/img/boximg2.png')); ?>" alt="box">
                ...
                <div class="col-lg-4">
                    <div class="box">
                        ...
                        <img src="<?php echo e(asset('assets/img/boximg3.png')); ?>" alt="box">
        ...
        <div class="swiper-slide">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="text mb-5">
                        ...
                        <p class="list mb-3">
                            ...
                            <img src="<?php echo e(asset('assets/img/dot.png')); ?>" alt="dot">
                ...
                <div class="col-lg-6">
                    ...
                    <!-- <img src="<?php echo e(asset('assets/img/section3Img.png')); ?>" class="img-fluid" alt="img"> -->
                    <div class="card_imgs d-flex align-items-center">
                        <div class="card_img img1 d-flex flex-column align-items-center">
                            <img src="<?php echo e(asset('assets/img/feature_img_1.png')); ?>" class="img-fluid" alt="img">
                            <div class="d-flex align-items-center justify-content-center">
                                <a href="#" class="btn btn_book">Book Now</a>
                            </div>
                        </div>
                        <div class="card_img img2 d-flex flex-column align-items-center absolute">
                            <img src="<?php echo e(asset('assets/img/feature_img_2.png')); ?>" class="img-fluid" alt="img">
                            <div class="d-flex align-items-center justify-content-center">
                                <a href="#" class="btn btn_book">Book Now</a>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="img">
                        ...
                        <!-- <img src="<?php echo e(asset('assets/img/client_feedback.png')); ?>" class="w-100" alt="client_feedback"> -->
                            <!-- Swiper -->
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="feedback shadow-sm">
                                            <div class="avatar">
                                                <img src="<?php echo e(asset('assets/img/avatar.png')); ?>" alt="avatar png">
                                            </div>
                                            <div class="text">
                    ...
                    <div class="box d-flex align-items-center flex-column">
                        ...
                        <div class="social mt-4">
                            <a href="#" class="mx-1">
                                ...
                                <img src="<?php echo e(asset('assets/img/instagram.png')); ?>" alt="instagram">
                            </a>
                            <a href="#" class="mx-1">
                                <!-- <img src="img/instagram.png" alt="instagram"> -->
                                <img src="<?php echo e(asset('assets/img/Social2.png')); ?>" alt="instagram">
                            </a>
                            <a href="#" class="mx-1">
                                <!-- <img src="img/instagram.png" alt="instagram"> -->
                                <img src="<?php echo e(asset('assets/img/Social3.png')); ?>" alt="instagram">
                            </a>
                            <a href="#" class="mx-1">
                                <!-- <img src="img/instagram.png" alt="instagram"> -->
                                <img src="<?php echo e(asset('assets/img/Social4.png')); ?>" alt="instagram">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="box flexmobile pe-lg-5 me-lg-5">
                        ...
                        <div class="input position-relative">
                            ...
                            <span class="icon">
                                ...
                                <img src="<?php echo e(asset('assets/img/send.png')); ?>" alt="send">
                            </span>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH /home/hashir/Pictures/trailer/oldmates/resources/views/frontend/index.blade.php ENDPATH**/ ?>