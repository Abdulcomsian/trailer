...
<body class="form_page">
        ...
        <div class="row mx-0">
            <div class="col-lg-5">
                <div class="side_content content1">
                     <form method="post" id="drop-trailer-form" action="{{url('User/Order/trailer-upload-photo')}}" enctype="multipart/form-data">
                            @csrf
                        <div class="upload_photo">
                            ...
                            <div class="mt-3">
                                <input class="form-control w-100 form_control" type="file" id="trailer-images" id="images" name="images[]" multiple required capture="camera">
    ...
    <script>
        window.onload = function(){
            let dropForm = document.getElementById("drop-trailer-form");
