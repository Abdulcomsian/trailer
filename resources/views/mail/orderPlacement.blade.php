                                                        ...
                                                        <tr>
                                                            <td style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:35px"><span class="im">
                                                                    ...
                                                                    <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
                                                                        ...
                                                                        @if($type=="user")
                                                                          @if($status=="Confirm")
                                                                          your order has been confirmed we will send you a passcode later.
                                                                          @elseif($status=="send")
                                                                          your order has been Approved and passcode is {{$code}}.
                                                                          @else
                                                                          Your order has been placed we will send you a passcode after verifying your order.
                                                                          @endif
                                                                        @else
                                                                        ...
                                                                        @else
                                                                        <a href="{{url('User/my_booking')}}">Click here to view order</a><br>
                                                                        @endif
                                                                    </p>
                                                                    ...
                                                                    <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;color:#74787e;font-size:16px;line-height:1.5em;margin-top:0;text-align:left">Thank you for your attention.<br><br>
                                                                        Regards<br><br>
                                                                        Trailer<br><br>
                                                                        <span style="font-size: 10px">If you have any problems portal, please contact us on info@trailer.co.uk</span>
                                                                    </p>
                                                                </span>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="center" style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;padding:35px">
                                                                <p style="font-family:Avenir,Helvetica,sans-serif;box-sizing:border-box;line-height:1.5em;margin-top:0;color:#aeaeae;font-size:12px;text-align:center">© 2022 Trailer. All rights reserved.</p>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
